  ...
  return (
    <Navbar>
      <Container>
        ...
        <Form inline id="search-form-wrapper">
        ...
        <Nav className="ml-auto">
          ...
          <Nav.Link href="#action2" className="profile-nav-wrapper">
            ...
            <NavDropdown align={{ lg: "eng" }} title="Me" id="dropdown-menu">
          ...
          <div className="d-flex right-nav">
            <div href="#features" className="pt-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                data-supported-dps="24x24"
                ...
                <div>
                  <ul>
                    ...
                    <li>
                      ...
                      <br />
                      <small>Get your job in front of quality candidates</small>
                    </li>
                    <li>
