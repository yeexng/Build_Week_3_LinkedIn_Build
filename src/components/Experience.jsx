            ...
            <Col className="d-flex flex-column mt-3 mb-3">
                <div className="d-flex align-items-center">
                    ...
                    <div className="ml-auto d-flex" >
                        <p className="mr-3 mb-0"><BiPlus onClick={handleShowPlus} id="analytics-icons"></BiPlus></p>
                    </div>
                </div>
            </Col>
            <Row className="d-flex mb-2">
                {userExperiencesAPIRS && userExperiencesAPIRS.map((data) =>
                    <><Row className="mb-3">
                        ...
                        <Col lg={11} className="pl-4 d-flex justify-content-between">
                            <div className="d-flex flex-column">
                                <p id="mini-headers" className="mb-0">Role: {data.role}</p>
                                <p id="post-details" className="mb-0">Company: {data.company}</p>
                                <p id="post-details" className="mb-0">Start Date: {data.startDate}</p>
                                <p id="post-details" className="mb-0">End Date: {data.endDate}</p>
                                <p id="post-details" className="mb-0">Description: {data.description}</p>
                                <p id="post-details" className="mb-0">Location: {data.area}</p>
                                <p>{data._id}</p>
                            </div>
                            <div className="d-flex">
                                <p className="mb-0" onClick={handleShowPen}><BiPencil id="analytics-icons"></BiPencil></p>
                                <p className="mb-0" onClick={() => {
                                    dispatch(deleteSpecificExperienceAction(userProfileAPIRS._id, data._id))
                                }}><RxCross2 id="analytics-icons"></RxCross2></p>
                            </div>
                        </Col>
